...
namespace AuthSystemAPI.Migrations
{
    ...
    [Migration("20260208234505_RemoveUserLogins")]
    partial class RemoveUserLogins
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthSystemAPI.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("AuthSystemAPI.Entities.LoginUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AuthSystemAPI.Entities.LoginUser", b =>
                {
                    b.HasOne("AuthSystemAPI.Models.ApplicationUser", "User")
                        .WithMany("LoginUsers")
            ...
            modelBuilder.Entity("AuthSystemAPI.Entities.RolePermission", b =>
                {
                    b.HasOne("AuthSystemAPI.Entities.Permission", "Permission")
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AuthSystemAPI.Entities.ApplicationRole", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("AuthSystemAPI.Entities.ApplicationRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
